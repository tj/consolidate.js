...
exports.gaikan = function(path, options, fn){
  var gaikan = requires.gaikan || (requires.gaikan = require('gaikan'));
  try {
    fn(null, gaikan.renderFile(options, null, path, null, options.cache));
  } catch (err) {
    fn(err);
  }
};
...
/**
 * Gaikan string support.
 */

exports.gaikan.render = function(str, options, fn) {
  var gaikan = requires.gaikan || (requires.gaikan = require('gaikan'));
  try {
    fn(null, gaikan.render(options, null, str));
  } catch (err) {
    fn(err);
  }
};