...
exports.octet = fromStringRenderer('octet');

/**
 * octet string support.
 */

exports.octet.render = function(str, options, fn){
  var engine = requires.octet || (requires.octet = require('octet'));
  try {
    var result = engine(str, options);
    fn(null, result.res);
  } catch (err) {
    fn(err);
  }
...
exports.j140 = fromStringRenderer('j140');

/**
 * j140 string support.
 */

exports.j140.render = function(str, options, fn){
  var engine = requires.j140 || (requires.j140 = require('j140'));
  try {
    fn(null, engine(str, options));
  } catch (err) {
    fn(err);
  }
};
