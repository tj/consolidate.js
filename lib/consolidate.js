...
exports.ect = function(path, options, fn){
  ...
  var engineConfig = { cache: options.cache };
  if (options.engineSettings) {
    for (var name in options.engineSettings) {
      if (options.engineSettings.hasOwnProperty(name)) {
        engineConfig[name] = options.engineSettings[name];
      }
    }
    delete options.engineSettings;
  }
